function d = makepov(pts,filename)
...
fprintf(fid,'camera {\n');
fprintf(fid,'   location <      155.5870      35.0405      1270.118>\n');
fprintf(fid,'   look_at <  15.5870   35.0405  25.7236>\n');
fprintf(fid,'   angle 4.5 }\n');

fprintf(fid,'light_source { <45,52,135> color White}\n');
fprintf(fid,'background {color rgb <1,1,1>}\n');
fprintf(fid,'#declare R1 = 0.63;\n');
