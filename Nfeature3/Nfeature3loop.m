function [r,nfeature] = Nfeature3loop(filestem,nfiles,lambda,w,field,Imin)
...
for j=1:nfiles,
    clear img image
    img=imread(strcat(filestem,num2str(j,'%05.0f'),'.tiff'));
...
r;
nfeature;
% dlmwrite(strcat(filestem,num2str(nfiles,'%02.0f'),'fr10feature.txt'),r,'\t')
% dlmwrite(strcat(filestem,num2str(nfiles,'%02.0f'),'fr10numfeatures.txt'),nfeature,'\t')
% r = [x,y,m,rg,e];
% b;
