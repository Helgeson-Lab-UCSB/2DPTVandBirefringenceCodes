...
%image parameters
lengthperpix=2/382;%distance per pixel
lengthunit='mm'; %unit of distance
framerate=180;%frames per time
timeunit='sec'; %unit of time
imagexres=2048;%pixel resolution of images
imageyres=1088;
numbofim=200;%number of images
imageloc='C:\Users\Patrick\16-6-13\NIST WLM H=5mm W=2mm XSL\0.480mlmin180fps';%image files location
imagename='0.48mlmin';%image name without '0000','0001',etc or '.tif'

%graphing parameters
xcenter=1050;%pixel center of geometry
ycenter=514;
maxMVGT=2;%colorbar maximum for MVGT (1/time)
...
minintensity=50;%minimum tracer particle intensity to be considered a feature, change this so between 300 and 500 features are found for a well conditioned system
searchrad=10;%pixel radius to search for particle between frames
