...
r3=[]
for i=1:117
    im=imread(strcat('C:\Users\HelgesonGp\Desktop\0.1 MCTAB 0.2M NaSal Near the rollers\Wi=1.5\Measurement3\Measurement30',num2str(i-1,'%03.0f'),'.tif'));
...
%  figure
%   for t=1:r(1)
%      plot(binvelocity(t,1)*10,binvelocity(t,3)*30,'k')
%      plot(binvelocity(t,2)*10,binvelocity(t,4)*30,'r')
%      hold on;
%   end
% 
